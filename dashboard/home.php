...
require 'functions/functionsHome.php';
...
<head>
  ...
  <title>Home | Manasa Agrowisata</title>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid px-4">
        <a class="btn btn-success mb-2" href="functions/tambahHome.php" role="button">Tambah Konten</a>
            ...
            <table class="table bg-white rounded shadow-sm  table-hover">
              <thead>
                <tr>
                  ...
                  <th scope="col" width="180">Judul</th>
              ...
              <tbody>
                ...
                <?php foreach ($home as $row) : ?>
                  <tr>
                    <td class="fs-6"><?= $i; ?></td>
                    <td class="fs-6"><?= $row["judulHome"]; ?></td>
                    <td class="fs-6"><img src="../img/<?= $row["gambarHome"]; ?>" class="gallery-item" style="cursor: pointer;"></td>
                    <td class="fs-6 hidden-on-mobile"><?= $row["deskripsiHome"]; ?></td>
                    <td class=" fs-6">
                      <a class="btn btn-outline-danger  " href="functions/hapusHome.php?id=<?= $row["idHome"]; ?>" onclick="return confirm('Anda yakin menghapus data ?');" role="button">Hapus</a> |
                      <a class="btn btn-outline-info" href="functions/ubahHome.php?idHome=<?= $row["idHome"]; ?>" role="button">Ubah</a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                <?php endforeach; ?>
