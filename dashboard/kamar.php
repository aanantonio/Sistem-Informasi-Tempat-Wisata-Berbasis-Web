...
require 'functions/functionsKamar.php';
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid px-4">
        <a class="btn btn-success" href="functions/tambahKamar.php" role="button">Tambah Kamar</a>
            ...
            <table class="table bg-white rounded-4 shadow-sm ">
              <thead>
                <tr>
                  ...
                  <th scope="col" class="hidden-on-mobile">Gambar</th>
              ...
              <tbody>
                ...
                <?php foreach ($kamar as $row) : ?>
                  <tr class="text-start">
                    <td class="fs-6"><?= $i; ?></td>
                    <td class="fs-6 hidden-on-mobile"><img src="../img/<?= $row["gambar"]; ?>" class="gallery-item" style="cursor: pointer; max-height: 400px; max-width: 400px;"></td>
                    <td class="fs-6"><?= $row["jenis"]; ?></td>
                    <td class="fs-6 ">Rp<?= $row["harga"]; ?></td>
                    <td class=" fs-6">
                      <a class="btn btn-outline-danger  " href="functions/hapusKamar.php?id_kamar=<?= $row["id_kamar"]; ?>" onclick="return confirm('Anda Yakin ?');" role="button">Hapus</a> |
                      <a class="btn btn-outline-info" href="functions/ubahKamar.php?id_kamar=<?= $row["id_kamar"]; ?>" role="button">Ubah</a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                <?php endforeach; ?>
