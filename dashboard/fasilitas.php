...
require 'functions/functionsFasilitas.php';
    ...
    <div id="page-content-wrapper">
      <nav class="navbar navbar-expand-lg navbar-light py-4 px-4">
        <div class="d-flex align-items-center">
          ...
          <h2 class="fs-2 m-0">Fasilitas</h2>
        </div>
      ...
      <div class="container-fluid px-4">
        <a class="btn btn-success" href="functions/tambahFasilitas.php" role="button">Tambah Fasilitas</a>
            ...
            <table class="table bg-white rounded-4 shadow-sm ">
              <thead>
                <tr>
                  ...
                  <th scope="col" class="hidden-on-mobile">Deskripsi</th>
                  <th scope="col" class="hidden-on-mobile">Tgl diubah</th>
              ...
              <tbody>
                ...
                <?php foreach ($fasilitas as $row) : ?>
                  <tr class="text-start">
                    <td class="fs-6"><?= $i; ?></td>
                    <td class="fs-6"><?= $row["namaFasilitas"]; ?></td>
                    <td class="fs-6"><img src="../img/<?= $row["gambar_fasilitas"]; ?>" class="gallery-item" style="cursor: pointer;
                    max-height: 400px"></td>
                    <td class="fs-6 hidden-on-mobile"><?= $row["deskripsi_fasilitas"]; ?></td>
                    <td class="fs-6 hidden-on-mobile"><?= $row["tgl_ubah"]; ?></td>
                    <td class=" fs-6">
                      <a class="btn btn-outline-danger  " href="functions/hapusFasilitas.php?id=<?= $row["id_fasilitas"]; ?>" onclick="return confirm('Anda yakin menghapus data ?');" role="button">Hapus</a> |
                      <a class="btn btn-outline-info" href="functions/ubahFasilitas.php?id_fasilitas=<?= $row["id_fasilitas"]; ?>" role="button">Ubah</a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                <?php endforeach; ?>
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body mt-0">
                <img src="../img/<?= $row["gambar_fasilitas"]; ?>" class="modal-img" alt="modal img">
              </div>
            </div>
          </div>
        </div>
